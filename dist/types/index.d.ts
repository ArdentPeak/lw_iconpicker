...
export interface QIconPicker extends ComponentPublicInstance {
     ...
     */
    iconSet? : 'material-icons' | 'material-icons-outlined' | 'material-icons-round' | 'material-icons-sharp' | 'ionicons-v4' | 'mdi-v4' | 'mdi-v5' | 'mdi-v6' | 'fontawesome-v5' | 'fontawesome-v6-light' | 'line-awesome' | 'eva-icons' | 'themify' | 'bootstrap-icons'
    /**
